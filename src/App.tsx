...
// LIST OF ALL THE TEAMS AND THEIR INFORMATION
const teams = [
...
function Welcome() {
  return (<h1>Welcome to my March Madness team directory!</h1>);
}

// THIS GRABS THE INFORMATION WE WANT FROM THE 'teams' OBJECT
...
// THIS WILL PRINT OF ALL OF THE ITEMS IN THE LIST
function TeamList() {
  return(
...
// RENDER THE APP USING THE App() function
function App() {
  return (
    <div>
        <Welcome/>
